...
const Footer: React.FC<FooterProps> = ({ slice }) => {
  return (
    <section
      ...
      <div className="charming-portfolio-container copyright">
        <p>
          {slice?.primary?.footer_credit_text 
            ? slice.primary.footer_credit_text.replace("[current_year]", new Date().getFullYear().toString()) 
